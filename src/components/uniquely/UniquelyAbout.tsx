    ...
    <section id="about" className="w-full px-4 sm:px-8 py-16 max-w-[1440px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16 items-start">
        ...
        <div className="md:col-span-9">
          <h2 className="font-syne text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-black leading-snug">
            Ayubowan and welcome —{" "}
            <span className="font-normal text-black/90">
              Uniquely Technologies is a digital innovation studio.
            </span>{" "}
            <span className="font-light text-black/70">
              We combine strategy, design, and intelligent technology to craft digital experiences that inspire, perform, and create lasting impact.
            </span>
          </h2>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="relative rounded-3xl p-6 flex flex-col justify-between h-[280px] overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-black/20 group-hover:opacity-85 transition-opacity duration-500" />
